...
namespace MainFormProject
{
    public partial class AdminUpdateInstructorMenu : Form
    {
        ...
        public AdminUpdateInstructorMenu(string newEmail)
        {
            InitializeComponent();
            email = newEmail;
        }
                ...
                if (Validations.ValidateDate(date))
                {
                    ...
                    try
                    {
                        ...
                        using (var context = new DrivingLessonBookingSystemContext())
                        {
                            ...
                            // Update in DB
                            context.Students.Where(i => i.Email == email).ExecuteUpdate(setters => setters.SetProperty(i => i.DateOfBirth, dateOfBirth));
